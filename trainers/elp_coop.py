    ...
    def load_model(self, directory, epoch=None):
        ...
        for name in names:
            ...
            try:
                ...
                if "size mismatch for linear_probe_proj" in str(e):
                    print(f"Warning: Size mismatch for linear_probe_proj in {name}. Skipping these weights.")
                    # Remove linear_probe_proj from state_dict and try again
                    new_state_dict = {k: v for k, v in state_dict.items() if "linear_probe_proj" not in k}
