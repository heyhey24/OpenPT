...
base = dict(
    ...
    data = dict(
        ...
        datasets_openset=[
            'openset_oxford_pets', 'openset_caltech101', 'openset_eurosat', 'openset_ucf101', 'openset_oxford_flowers',
            'openset_food101', 'openset_dtd', 'openset_fgvc_aircraft', 'openset_sun397','openset_stanford_cars','openset_imagenet'],
